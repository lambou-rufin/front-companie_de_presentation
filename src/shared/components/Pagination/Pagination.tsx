...
const PaginationComponent: FC<any> = ({
  itemPerPage,
  totalItems,
  paginate,
  currentPage,
  ...
  const paginationItems = paginationNumber()
  ...
  return (
    <div className="pagination-wrap">
      ...
      <div className="pagination-info small">
        Affichage {itemPerPage * (currentPage - 1) + 1} de{' '}
        {totalItems > itemPerPage * currentPage ? itemPerPage * currentPage : totalItems} à{' '}
        {totalItems} entrées
      </div>
    </div>
  )
